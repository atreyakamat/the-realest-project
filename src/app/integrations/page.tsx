...
const integrationGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'WhatsApp Cloud API', status: 'Ready', detail: 'Native Meta messaging connector. Add your Phone Number ID in settings.' },
  ...
  },
  {
    ...
    items: [
      { name: 'Google Calendar', status: 'Ready', detail: 'Sync site visits, team meetings, and follow-up reminders via OAuth.' },
      { name: 'Google Sheets', status: 'Ready', detail: 'Automated OAuth sync for leads. Click the link below to connect.' },
      { name: 'Google Drive', status: 'Ready', detail: 'Store brochures, plans, and shareable documents securely via OAuth.' },
