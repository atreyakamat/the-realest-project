...
export async function saveSettingsAction(_prevState: { message: string; error: string }, formData: FormData) {
  ...
  const settings: SettingSeed[] = [
    ...
    { key: 'google_calendar_client_id', value: String(formData.get('google_calendar_client_id') ?? ''), isSecret: true },
    { key: 'google_calendar_client_secret', value: String(formData.get('google_calendar_client_secret') ?? ''), isSecret: true },
    { key: 'google_sheets_spreadsheet_id', value: String(formData.get('google_sheets_spreadsheet_id') ?? ''), isSecret: false },
    { key: 'google_sheets_webhook_url', value: String(formData.get('google_sheets_webhook_url') ?? ''), isSecret: true },
    { key: 'google_drive_folder_id', value: String(formData.get('google_drive_folder_id') ?? ''), isSecret: false },
    { key: 'meta_lead_ads_access_token', value: String(formData.get('meta_lead_ads_access_token') ?? ''), isSecret: true },
    { key: 'meta_lead_ads_app_id', value: String(formData.get('meta_lead_ads_app_id') ?? ''), isSecret: false },
    { key: 'meta_lead_ads_app_secret', value: String(formData.get('meta_lead_ads_app_secret') ?? ''), isSecret: true },
    { key: 'slack_webhook_url', value: String(formData.get('slack_webhook_url') ?? ''), isSecret: true },
    { key: 'zapier_webhook_url', value: String(formData.get('zapier_webhook_url') ?? ''), isSecret: true },
    { key: 'make_webhook_url', value: String(formData.get('make_webhook_url') ?? ''), isSecret: true },
